...
namespace UnlockAll
{
    [BepInPlugin("com.xoxfaby.UnlockAll", "UnlockAll", "1.0.1")]
    public class UnlockAllPlugin : BetterUnityPlugin.BetterUnityPlugin<UnlockAllPlugin>
    {
        ...
        {
            var statSheet = orig();
            Array.Copy(UnlockableCatalog.indexToDefTable, statSheet.unlockables, UnlockableCatalog.indexToDefTable.Length);
            return statSheet;
        }
